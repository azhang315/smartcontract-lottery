...
DECIMALS = 8
INITIAL_VALUE = 200000000000 #2000.00000000
...
def get_contract(contract_name):
    ...
    if network.show_active() in LOCAL_BLOCKCHAIN_ENVIRONMENTS:
        if len(contract_type) <= 0: 
            deploy_mocks() # e.g. MockV3Aggregator.length
...
def fund_with_link(contract_address, account=None, link_token=None, amount=Web3.toWei(0.1, "ether"): # 0.1 LINK
